    ...
    >
      ...
      >
        ...
        <div className="absolute inset-3 bg-gradient-to-tr from-black/95 via-[#080808] to-white/[0.04] rounded-full border border-white/[0.08] group-hover:border-white/[0.22] shadow-[inset_0_0_20px_rgba(0,0,0,0.95),0_10px_30px_rgba(0,0,0,0.6)] group-hover:shadow-[0_15px_40px_rgba(255,255,255,0.06)] transition-all duration-700 flex items-center justify-center overflow-hidden">
          ...
          {/* Ambient glow */}
          {accentColor === 'heritage' && <div className="absolute bottom-0 right-0 w-24 h-24 bg-red-500/5 rounded-full blur-xl group-hover:bg-red-500/15 transition-colors duration-700" />}
          {accentColor === 'modern' && <div className="absolute bottom-0 right-0 w-24 h-24 bg-amber-500/5 rounded-full blur-xl group-hover:bg-amber-500/15 transition-colors duration-700" />}
          {accentColor === 'atelier' && <div className="absolute bottom-0 right-0 w-24 h-24 bg-white/5 rounded-full blur-xl group-hover:bg-white/10 transition-colors duration-700" />}
      ...
      >
        ...
        <div className="flex justify-between items-center w-full relative z-10">
          ...
          {/* Brand Logo */}
          <div className="w-8 h-8 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-xl md:rounded-2xl bg-black/60 border border-white/[0.08] group-hover:border-white/20 transition-all duration-700 flex items-center justify-center relative overflow-hidden shadow-inner shrink-0">
