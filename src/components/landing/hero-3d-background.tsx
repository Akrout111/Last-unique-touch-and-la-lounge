...
export default function Hero3DBackground() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // SCENE ASSEMBLY
      // ═════════════════════════════════════════════════════════════════
      scene.add(createLutFurniture(sectionZs.lut, isMobile ? 0.6 : 1.0))
      scene.add(createBirthdayParty(sectionZs.birthday, isMobile ? 0.6 : 1.0))
      ...
      const moteCount = isMobile ? 100 : 200
