...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 end-6 z-50 size-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center hover:-translate-y-0.5 hover:shadow-xl transition-[transform,box-shadow]"
    >
